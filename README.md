...
As an example, you can use the data from our article. They are presented in the [example_data_from_article](example_data_from_article) folder.

# Dependencies
To run code need to install [git](https://git-scm.com/) and [pip](https://pypi.org/project/pip/) or [conda](https://www.anaconda.com/) package manager.
